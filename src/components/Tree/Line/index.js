                ...
                : [
                    ...
                    this.showLabelLine
                        ? $createElement('span', {
                            ...
                            style: { 'border-top': this.showLine ? this.lineStyle : '' },
                        })
                        : null,
            ...
            for (let i = 0; i < this.node.level; i++) {
                ...
                lineNodes.push(
                    $createElement('span', {
                        ...
                        style: { left: this.indent * i + 'px', 'border-left': this.showLine ? this.lineStyle : '' },
                    })
                );
            }
                ...
                [labelNodes].concat(lineNodes).concat([
                    $createElement('span', {
                        ...
                        style: {
                            ...
                            'border-bottom': this.showLine ? this.lineStyle : ''
                        },
                    }),
                ])
            );
